...
export default function AuthButton({ user }: AuthButtonProps) {
  ...
  if (user) {
    return (
      <div className="relative" ref={menuRef}>
        ...
        {isMenuOpen && (
          <div className="absolute right-0 top-full mt-2 w-48 bg-white dark:bg-gray-900 rounded-2xl shadow-card border border-gray-100 dark:border-gray-800 overflow-hidden z-50">
            <button
  ...
  return (
    <div className="relative" ref={menuRef}>
      ...
      {isMenuOpen && (
        <div className="absolute right-0 top-full mt-2 w-56 bg-white dark:bg-gray-900 rounded-2xl shadow-card border border-gray-100 dark:border-gray-800 overflow-hidden z-50">
